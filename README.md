...
<head>
  ...
  <title>Brain and Mind Academy • Substitution Rule Master Suite (Examples 1-5)</title>
...
<body>
  ...
  <header>
    <div class="brand-wrap">
      ...
      <div class="brand-title">
        <h1>Brain and Mind Academy • U-Substitution Master Suite</h1>
        <p>Examples 1 to 5 Mapped Practice • Step-Gated Evaluation &amp; Virtual Keyboard</p>
      </div>
    </div>
  ...
  <nav>
    <button class="tab-btn active" id="tabPracticeBtn" onclick="switchMainTab('practice')">
      🎯 Interactive Practice Workstation (16 Mapped Examples)
    </button>
  ...
  <div id="loginGateView">
    <div class="login-box">
      ...
      <p>Calculus I • U-Substitution Examples 1-5 Practice with Step-Gating &amp; Virtual Keyboard</p>
  ...
  <main>
    <!-- View 1: Interactive Practice Workstation -->
  ...
  <script>
    /* ==========================================================================
       16 MAPPED EXAMPLES FROM IMAGES (EXAMPLES 1 TO 5)
       ========================================================================== */
    const rawExamples = [
      // Example 1
      { id: 1, title: "Example 1(a)", expr: "\\int \\left( e^{2t} + \\sec(2t)\\tan(2t) \\right) \\ dt", hint: "Integrate term by term using u-substitution \\(u = 2t\\).", uSub: "u = 2t, \\quad du = 2 \\, dt", ans: "\\frac{1}{2}e^{2t} + \\frac{1}{2}\\sec(2t) + C", dist1: "e^{2t} + \\sec(2t) + C", dist2: "\\frac{1}{2}e^{2t} + \\sec(2t) + C", dist3: "2e^{2t} + 2\\sec(2t) + C" },
      { id: 2, title: "Example 1(b)", expr: "\\int \\sin(t) \\left( 4\\cos^3(t) + 6\\cos^2(t) - 8 \\right) \\ dt", hint: "Let \\(u = \\cos t\\), then \\(du = -\\sin t \\, dt\\).", uSub: "u = \\cos t, \\quad du = -\\sin t \\, dt", ans: "-\\cos^4(t) - 2\\cos^3(t) + 8\\cos(t) + C", dist1: "\\cos^4(t) + 2\\cos^3(t) - 8\\cos(t) + C", dist2: "-4\\cos^4(t) - 6\\cos^3(t) + 8\\cos(t) + C", dist3: "\\frac{4}{4}\\cos^4(t) + \\frac{6}{3}\\cos^3(t) + C" },
      { id: 3, title: "Example 1(c)", expr: "\\int \\left( x \\cos(x^2 + 1) + \\frac{x}{x^2 + 1} \\right) \\ dx", hint: "Let \\(u = x^2 + 1\\), then \\(du = 2x \\, dx\\).", uSub: "u = x^2 + 1, \\quad du = 2x \\, dx", ans: "\\frac{1}{2}\\sin(x^2 + 1) + \\frac{1}{2}\\ln|x^2 + 1| + C", dist1: "\\sin(x^2 + 1) + \\ln|x^2 + 1| + C", dist2: "\\frac{1}{2}\\cos(x^2 + 1) + \\frac{1}{2}\\ln|x^2 + 1| + C", dist3: "2\\sin(x^2 + 1) + 2\\ln|x^2 + 1| + C" },

      // Example 2
      { id: 4, title: "Example 2(a)", expr: "\\int \\left( x^2 + e^{1-x} \\right) \\ dx", hint: "Integrate \\(x^2\\) normally and use u-sub \\(u = 1-x\\) for \\(e^{1-x}\\).", uSub: "u = 1 - x, \\quad du = -dx", ans: "\\frac{1}{3}x^3 - e^{1-x} + C", dist1: "\\frac{1}{3}x^3 + e^{1-x} + C", dist2: "x^3 - e^{1-x} + C", dist3: "\\frac{1}{3}x^3 - \\frac{1}{2}e^{1-x} + C" },
      { id: 5, title: "Example 2(b)", expr: "\\int \\left( x \\cos(x^2 + 1) + \\frac{1}{x^2 + 1} \\right) \\ dx", hint: "First term uses \\(u = x^2+1\\); second term is standard arctan.", uSub: "u = x^2 + 1, \\quad du = 2x \\, dx", ans: "\\frac{1}{2}\\sin(x^2 + 1) + \\arctan(x) + C", dist1: "\\sin(x^2 + 1) + \\arctan(x) + C", dist2: "\\frac{1}{2}\\cos(x^2 + 1) + \\arctan(x) + C", dist3: "\\frac{1}{2}\\sin(x^2 + 1) + \\frac{1}{x^2+1} + C" },

      // Example 3
      { id: 6, title: "Example 3(a)", expr: "\\int \\left( e^{-z} + \\sec^2\\left(\\frac{z}{10}\\right) \\right) \\ dz", hint: "Use u-sub \\(u = -z\\) and \\(u = z/10\\).", uSub: "u = -z \\text{ and } u = \\frac{z}{10}", ans: "-e^{-z} + 10\\tan\\left(\\frac{z}{10}\\right) + C", dist1: "e^{-z} + 10\\tan\\left(\\frac{z}{10}\\right) + C", dist2: "-e^{-z} + \\frac{1}{10}\\tan\\left(\\frac{z}{10}\\right) + C", dist3: "-e^{-z} + \\tan\\left(\\frac{z}{10}\\right) + C" },
      { id: 7, title: "Example 3(b)", expr: "\\int \\left( \\sin w \\sqrt{1 - 2\\cos w} + \\frac{1}{7w + 2} \\right) \\ dw", hint: "Let \\(u = 1 - 2\\cos w\\) for the first term and \\(v = 7w + 2\\) for the second.", uSub: "u = 1 - 2\\cos w, \\quad v = 7w + 2", ans: "\\frac{1}{3}(1 - 2\\cos w)^{3/2} + \\frac{1}{7}\\ln|7w + 2| + C", dist1: "\\frac{2}{3}(1 - 2\\cos w)^{3/2} + \\ln|7w + 2| + C", dist2: "\\frac{1}{3}(1 - 2\\cos w)^{3/2} + \\frac{1}{7(7w+2)} + C", dist3: "(1 - 2\\cos w)^{3/2} + \\frac{1}{7}\\ln|7w + 2| + C" },
      { id: 8, title: "Example 3(c)", expr: "\\int \\frac{10x + 3}{x^2 + 16} \\, dx", hint: "Split into two integrals: \\(\\frac{10x}{x^2+16} + \\frac{3}{x^2+16}\\).", uSub: "u = x^2 + 16, \\quad du = 2x \\, dx", ans: "5\\ln|x^2 + 16| + \\frac{3}{4}\\arctan\\left(\\frac{x}{4}\\right) + C", dist1: "10\\ln|x^2 + 16| + \\frac{3}{16}\\arctan\\left(\\frac{x}{4}\\right) + C", dist2: "5\\ln|x^2 + 16| + 3\\arctan(x) + C", dist3: "\\frac{5}{x^2+16} + \\frac{3}{4}\\arctan\\left(\\frac{x}{4}\\right) + C" },

      // Example 4
      { id: 9, title: "Example 4(a)", expr: "\\int \\tan x \\, dx", hint: "Rewrite as \\(\\int \\frac{\\sin x}{\\cos x} dx\\) and let \\(u = \\cos x\\).", uSub: "u = \\cos x, \\quad du = -\\sin x \\, dx", ans: "-\\ln|\\cos x| + C", dist1: "\\ln|\\sin x| + C", dist2: "\\ln|\\cos x| + C", dist3: "-\\ln|\\sin x| + C" },
      { id: 10, title: "Example 4(b)", expr: "\\int \\sec y \\, dy", hint: "Multiply numerator and denominator by \\(\\sec y + \\tan y\\).", uSub: "u = \\sec y + \\tan y, \\quad du = (\\sec y \\tan y + \\sec^2 y)dy", ans: "\\ln|\\sec y + \\tan y| + C", dist1: "\\ln|\\sec y - \\tan y| + C", dist2: "\\sec y \\tan y + C", dist3: "\\ln|\\csc y + \\cot y| + C" },
      { id: 11, title: "Example 4(c)", expr: "\\int \\frac{\\cos(\\sqrt{x})}{\\sqrt{x}} \\, dx", hint: "Let \\(u = \\sqrt{x}\\), then \\(du = \\frac{1}{2\\sqrt{x}}dx\\).", uSub: "u = \\sqrt{x}, \\quad du = \\frac{1}{2\\sqrt{x}}dx", ans: "2\\sin(\\sqrt{x}) + C", dist1: "\\sin(\\sqrt{x}) + C", dist2: "\\frac{1}{2}\\sin(\\sqrt{x}) + C", dist3: "4\\sin(\\sqrt{x}) + C" },
      { id: 12, title: "Example 4(d)", expr: "\\int e^{t + e^t} \\, dt", hint: "Rewrite as \\(\\int e^t \\cdot e^{e^t} dt\\) and let \\(u = e^t\\).", uSub: "u = e^t, \\quad du = e^t dt", ans: "e^{e^t} + C", dist1: "e^{t + e^t} + C", dist2: "\\frac{1}{2}e^{e^t} + C", dist3: "t e^{e^t} + C" },
      { id: 13, title: "Example 4(e)", expr: "\\int 2x^3 \\sqrt{x^2 + 1} \\, dx", hint: "Let \\(u = x^2 + 1\\), so \\(x^2 = u - 1\\).", uSub: "u = x^2 + 1, \\quad du = 2x \\, dx", ans: "\\frac{2}{5}(x^2+1)^{5/2} - \\frac{2}{3}(x^2+1)^{3/2} + C", dist1: "\\frac{1}{3}(x^2+1)^{3/2} + C", dist2: "\\frac{2}{5}(x^2+1)^{5/2} + C", dist3: "\\frac{2}{3}(x^2+1)^{3/2} + C" },

      // Example 5
      { id: 14, title: "Example 5(a)", expr: "\\int \\frac{1}{x \\ln x} \\, dx", hint: "Let \\(u = \\ln x\\), then \\(du = \\frac{1}{x}dx\\).", uSub: "u = \\ln x, \\quad du = \\frac{1}{x}dx", ans: "\\ln|\\ln x| + C", dist1: "\\frac{1}{(\\ln x)^2} + C", dist2: "\\ln|x| + C", dist3: "\\frac{1}{x} + C" },
      { id: 15, title: "Example 5(b)", expr: "\\int \\frac{e^{2t}}{1 + e^{2t}} \\, dt", hint: "Let \\(u = 1 + e^{2t}\\), then \\(du = 2e^{2t}dt\\).", uSub: "u = 1 + e^{2t}, \\quad du = 2e^{2t}dt", ans: "\\frac{1}{2}\\ln|1 + e^{2t}| + C", dist1: "\\ln|1 + e^{2t}| + C", dist2: "\\frac{1}{2}e^{2t} + C", dist3: "\\arctan(e^t) + C" },
      { id: 16, title: "Example 5(c)", expr: "\\int \\frac{e^{2t}}{1 + e^{4t}} \\, dt", hint: "Notice \\(e^{4t} = (e^{2t})^2\\). Let \\(u = e^{2t}\\).", uSub: "u = e^{2t}, \\quad du = 2e^{2t}dt", ans: "\\frac{1}{2}\\arctan(e^{2t}) + C", dist1: "\\arctan(e^{2t}) + C", dist2: "\\frac{1}{2}\\ln|1 + e^{4t}| + C", dist3: "\\frac{1}{4}\\arctan(e^{2t}) + C" }
    ];

    const PROBLEMS_DATA = [];

    rawExamples.forEach(item => {
      const uOptsAll = [
        { text: `\\(${item.uSub}\\)`, isCorrect: true },
        { text: `\\(u = x, \\quad du = dx\\)`, isCorrect: false },
        { text: `\\(u = t^2, \\quad du = 2tdt\\)`, isCorrect: false },
        { text: `\\(u = \\text{constant}, \\quad du = 0\\)`, isCorrect: false }
      ];
      const uPos = (item.id * 2) % 4;
      const uCorrect = uOptsAll[0];
      const uDists = [uOptsAll[1], uOptsAll[2], uOptsAll[3]];
      const finalUOpts = [];
      let ud = 0;
      for (let i = 0; i < 4; i++) {
        if (i === uPos) {
          finalUOpts.push({ label: String.fromCharCode(65 + i), text: uCorrect.text });
        } else {
          finalUOpts.push({ label: String.fromCharCode(65 + i), text: uDists[ud++].text });
        }
      }
      ...
      const intPos = (item.id * 3) % 4;
      const intCorrect = intOptsAll[0];
      const intDists = [intOptsAll[1], intOptsAll[2], intOptsAll[3]];
      const finalIntOpts = [];
      let idist = 0;
      for (let i = 0; i < 4; i++) {
        if (i === intPos) {
          finalIntOpts.push({ label: String.fromCharCode(65 + i), text: intCorrect.text });
        } else {
          finalIntOpts.push({ label: String.fromCharCode(65 + i), text: intDists[idist++].text });
        }
      }
      ...
      PROBLEMS_DATA.push({
        ...
        steps: [
          {
            title: "Step 1: Identify Substitution and Differential",
            prompt: "Select the correct substitution variable \\(u\\) and differential \\(du\\).",
            options: finalUOpts,
            correctIndex: uPos,
            explanation: `Choosing \\(${item.uSub}\\) properly aligns the composite function with its derivative factor.`
          },
          {
            title: "Step 2: Evaluate Integral and Substitute Back",
            prompt: "Compute the evaluated antiderivative.",
            options: finalIntOpts,
            correctIndex: intPos,
            explanation: `Evaluating the integral yields \\(${item.ans}\\).`
          }
        ]
      });
    });
    ...
    /* ==========================================================================
       ...
       ========================================================================== */
    const STORAGE_KEY = "brain_mind_academy_usub_examples_1_5_v1";
    ...
    function loadProblem(pId) {
      ...
      card.innerHTML = `
        <div style="display:flex; justify-content:space-between; align-items:center; flex-wrap:wrap;">
          ...
          <span style="font-size:0.82rem; color:var(--text-muted);">Calculus I: U-Substitution Examples 1-5</span>
        </div>
